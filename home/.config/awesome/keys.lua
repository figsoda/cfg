  ...
  { mc, "l", exec("lockscreen") },
  {
    ...
    function()
      awful.spawn.easy_async_with_shell(
        "echo '1 ⏻  shutdown | poweroff,2   reboot,3 ⏼  suspend,4 󰖔  hibernate,5 󰌾  lock screen,6   quit | log out,7   reload awesome,8   restart firefox' | rofi -dmenu -sep , -p session -format i -no-custom -select 8",
        function(stdout)
          ({
            exec("poweroff"),
            exec("reboot"),
